...
public class RemoteFrame extends JFrame implements Runnable {
    ...
    public RemoteFrame(ClientPanel client_panel, CommonBus common_bus, String quality) throws Exception {
        ...
        this.setTitle("Remoting: " + common_bus.getRmiClient().getHost()+":"+common_bus.getRmiClient().getPort());
    ...
    private void initComponents() throws RemoteException {
        ...
        this.menu_bar.setFont(new Font(MainFrame.GLOBAL_FONT, Font.PLAIN, 12));
    ...
    public void run() {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(this, "Server disconnect or wrong password");
            this.dispose();
        }
    }
