...
public class DrivesInfoPanel extends JPanel {
    ...
    public void updateInfo(ComputerInfo pc_info) {
        EventQueue.invokeLater(() -> {
            ...
            os_name_label.setFont(new Font(MainFrame.GLOBAL_FONT, Font.BOLD | Font.ITALIC, 17));
            ...
            for(DriveInfo drive : pc_info.getDrives()) {
                ...
                drive_label.setIcon(new ImageIcon(this.getClass().getClassLoader().getResource("images/hdd_icon.png")));
                drive_label.setFont(new Font(MainFrame.GLOBAL_FONT, Font.PLAIN, 12));
