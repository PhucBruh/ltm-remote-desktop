...
public class ClientPanel extends JPanel {
    public final static String BACKGROUND = "0xf4f9ff";
    public final static String FOREGROUND = "0x2c3e50";
    ...
    private void initComponents() {
        ...
        this.connect_label.setFont(new Font(MainFrame.GLOBAL_FONT, Font.PLAIN, 14));
                    ...
                    EventQueue.invokeLater(() -> {
                        try {
                            if(this.low_radio.isSelected()) {
                                new RemoteFrame(this, this.common_bus, "jpeg");
                            }
