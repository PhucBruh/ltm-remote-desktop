...
public class MainFrame extends JFrame {
    ...
    private void initComponents() {
        ...
        this.client_label.setForeground(Color.WHITE);
        ...
        this.server_label.setForeground(Color.WHITE);
