...
public class CommonPanel extends JPanel {
    ...
    public CommonPanel() {
        ...
        this.setBorder(BorderFactory.createTitledBorder(null, "Server Listening",
            ...
            new Font(MainFrame.GLOBAL_FONT, Font.BOLD, 16),
    ...
    private void initcomponents() {
        ...
        this.host_label.setFont(new Font(MainFrame.GLOBAL_FONT, Font.BOLD, 13));
        ...
        this.port_label.setFont(new Font(MainFrame.GLOBAL_FONT, Font.BOLD, 13));
        ...
        this.pass_label.setText("Password:");
        this.pass_label.setBounds(30, 90, 100, 30);
        this.pass_label.setFont(new Font(MainFrame.GLOBAL_FONT, Font.BOLD, 13));
        ...
        this.help_label.setFont(new Font(MainFrame.GLOBAL_FONT, Font.BOLD, 12));
